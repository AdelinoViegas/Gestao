...
$data = getData($connection, "SELECT * FROM sg_classe WHERE id_c =?", [$class_id]);
?>
  ...
  <div class="fontes rounded-3" id="divm">
    ...
    <form action="classe-editar-processar.php" method="post">
      ...
      <div class="row marg">
        ...
        <a href="menu-classes.php" class="btn btn-outline-secondary btn-block col-md-2" name="btn-voltar">Voltar</a>
      </div>
    </form>
  </div>

...
$id_estudante = $_SESSION['ida'];
     ...
     $valor = mysqli_query($conexao,"SELECT * FROM sg_notas AS n JOIN sg_aluno AS a ON n.id_aluno = a.id_a JOIN sg_gerenciar AS g ON g.id_g = n.id_gerenciar JOIN sg_disciplina AS d ON d.id_d = g.idDisciplina WHERE id_aluno = '$id_estudante' AND id_trimestre = '1' ");
    ...
    $valor1 = mysqli_query($conexao,"SELECT * FROM sg_notas AS n JOIN sg_aluno AS a ON n.id_aluno = a.id_a JOIN sg_gerenciar AS g ON g.id_g = n.id_gerenciar JOIN sg_disciplina AS d ON d.id_d = g.idDisciplina WHERE id_aluno = '$id_estudante' AND id_trimestre = '2' ");
   ...
   $valor2 = mysqli_query($conexao,"SELECT * FROM sg_notas AS n JOIN sg_aluno AS a ON n.id_aluno = a.id_a JOIN sg_gerenciar AS g ON g.id_g = n.id_gerenciar JOIN sg_disciplina AS d ON d.id_d = g.idDisciplina WHERE id_aluno = '$id_estudante' AND id_trimestre = '3' ");
...
<table class="table table-hover table-bordered" id="table">
  ...
  <tbody>
      <?php 
       $res = mysqli_query($conexao,"SELECT * FROM sg_notas WHERE id_aluno = '$id_estudante'"); 
     ...
     <tr>    
      ...
      <td><?php echo "<input class='form-control ps-1' type='text' readonly value='".number_format($v[$c],2)."'>"  ?>
      </td>
      <td><?php echo "<input class='form-control ps-1' type='text' readonly value='".number_format($v1[$c],2)."'>"  ?>
      </td>
      <td><?php echo "<input class='form-control ps-1' type='text' readonly value='".number_format($v2[$c],2)."'>"  ?>
      </td>
...
<!--</form>-->
<button type="submit" id="adicionar" class="btn btn-info my-2">Condição Final</div>

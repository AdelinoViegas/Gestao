    ...
    <form action="" method="post">
      <div class="row">
        <div class="form-group col-md-4" id="margemB">
          ...
          <select id="texttrimestre" class="input form-control" name="trimestre" required>
        ...
        <div class="form-group col-md-2" id="margemB">
          <label></label>
          <button type="submit" id="inserir" class="btn btn-success col-md-12" name="ok">Buscar</button>
        </div>
      </div>
    </form>
  </div>

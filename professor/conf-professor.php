...
if(isset($_POST['btn-senha'])){
 ...
 if($senha === $senha_nova){
   ...
   mysqli_query($conexao,"UPDATE sg_usuarios SET senha_u ='$senha',dataModificacao_u = '$dt' WHERE id_u ='$id_user'"); 
      ...
      <form action="conf-professor.php" method="post">
        ...
        <div class="row">
         <div class="form-group col-md-4 mb-3">
           ...
           <input type="password" id="tsenha" class="form-control"
           name="txtsenha" maxlength="30" placeholder="Insira nova senha" required>
         </div>

         <div class="form-group col-md-4 mb-3">
            <label for="tsenha">Confirmar senha</label>
           <input type="password" id="tsenha" class="form-control"
           name="txtnova" maxlength="30" placeholder="Confirmar nova senha" required>
         </div>

        <div class=" col-md-2 mb-3" >
          <label></label>
           <button type="submit" id="inserir" class="btn btn-success col-md-12" 
           name="btn-senha">Gravar</button>
      </div>

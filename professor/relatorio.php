...
$pdf->ezText("Republica de Angola", $size, ['justification'=>'center']);
$pdf->ezText("Governo da Provincia de Angola", $size, ['justification'=>'center']);
$pdf->ezText("Administracao Municipal do Cazenga", $size, ['justification'=>'center']);
$pdf->ezText("Direção da Educação", $size, ['justification'=>'center']);

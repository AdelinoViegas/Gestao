...
if(isset($_POST['btn-cadastrar'])){
    $turmaAluno = mysqli_escape_string($conexao,$_POST['txtturma']);
    $classeAluno = mysqli_escape_string($conexao,$_POST['txtclasse']);
    ...
    $encarregado = mysqli_escape_string($conexao,$_POST['txtencarregado']);

  $sql_nome = "SELECT nome_a FROM sg_aluno WHERE nome_a = '$nome' ";
   ...
   <div id='alerta-confirmar'>
     <div class='alerta-confirmar'>
        <div class='alert alert-danger alert-dimissible'>
         <button style='float:right;' class='btn-close' data-bs-dismiss='alert'></button>
          ...
          $_SESSION['Aluno-cadastrado'] = "
           <div id='alerta-confirmar'>
            ...
            $sql_enc =mysqli_query($conexao,"SELECT * FROM sg_encarregado WHERE nome_e = '$encarregado'");
         ...
         $r_usuario = mysqli_query($conexao,"INSERT INTO  sg_usuarios(nome_u,senha_u,estado_u,painel_u,dataCadastro_u,dataModificacao_u) VALUES ('$nome','$senha','activo','aluno','$dt','$dt')");
         ...
         $r_aluno = mysqli_query($conexao,"INSERT INTO sg_aluno(idTurma_a,idClasse,idEncarregado,idUsuario,nome_a,sexo_a,nascimento_a,municipio_a,bairro_a,contato_a,numeroBI_a,dataCadastro_a,dataModificacao_a) VALUES ('$turmaAluno','$classeAluno','$id_enc','$iduser','$nome','$sexo','$datNasc','$mun','$bairro','$contato','$numeroBI','$dt','$dt')");   
      ...
      <form action="aluno-cadastro.php" method="post">
        ...
        <div class="row">
         <div class="form-group col-md-6 mb-3" >
           ...
           name="txtnome" maxlength="45" placeholder="Nome completo do aluno/a" required>
         </div>
         <div class="form-group col-md-3 mb-3">
          ...
          <?php             
          $query = mysqli_query($conexao,"SELECT id_c,nome_c FROM sg_classe ORDER BY id_c");
         ...
         <div class="form-group col-md-3 mb-3">
          ...
          <?php          
          $query = mysqli_query($conexao,"SELECT id_t,nome_t FROM sg_turma ORDER BY nome_t");
       ...
       <div class="row">
         <div class="form-group col-md-4 mb-3">
           ...
           name="txtcont" placeholder="xxx-xx-xx-xx" maxlength="9" value="Opcional">
         </div>
          <div class="form-group col-md-4 mb-3">
         ...
         <div class="row">
           ...
           <input type="text" id="textencarregado" class="form-control"
           name="txtencarregado" maxlength="45" placeholder="Nome completo do encarregado/a" required>
         </div>
        </div>

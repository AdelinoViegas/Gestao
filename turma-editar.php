...
<div class="fontes rounded-3" id="divm">
    ...
    <div class="divsuperior3">
      ...
      <form action="turma-editar-processar.php" method="post">

        <div class="row margB">
         <div class="form-group col-md-4" id="margemB">
            <label for="textnome">Nome</label>
           <input type="text" id="textnome" class="form-control"
           name="txtnome" maxlength="30" value="<?php echo $registro['nome_t']; ?>" placeholder="Nome da disciplina" required>
         </div>
        </div>
        ...
        <div class="row marg">
          ...
          <a href="menu-turmas.php" class="btn btn-outline-secondary btn-block col-md-2" 

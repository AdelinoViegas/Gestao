    ...
    <form action="gerenciar-editar-processar.php" method="post">
      <div class="row margB">
        <div class="form-group col-md-4" id="margemB">
          ...
          <select id="textdisciplina" class="input form-control" name="txtdisciplina" required>
        ...
        <div class="form-group col-md-4" id="margemB">
          ...
          <select id="textprofessor" class="input form-control" name="txtprofessor" required>
